...
\begin{algorithm}\label{alg:delta_medoids_full}
    ...
    \end{algorithmic}
\end{algorithm}
\todo{add my improvement to the pseudocode - omezeni ze jeden reprezentant musi zabirat minimalne 1 procento vsech bodu, take reprezentantu nesmi byt vice nez 50 nebo vice nez 10 procent celeho clusteru}
