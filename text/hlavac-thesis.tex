...
\begin{figure}
  ...
  \label{img:centroids}
  \caption{Centroid of a cluster calculated as mean of all points.}
\end{figure}

However, if a calculated centroid is not meaningful (see Figure~\ref{img:centroids} b)), a medoid can be selected as a prototype.
