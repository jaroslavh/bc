...
The similarity measure that is used in this thesis as explained in Section~\ref{sec:ctdaf} does not fulfill the last point of the definition above. Furthermore, it is a pairwise similarity that forms form a subspace for comparing each pair of samples.
