...
The selected method should be finetuned to get the best possible results in anomaly-detection. \todo{Would this paragraph be more clear if I made a bullet point list?}
...
\end{itemize}  \todo{Add formulas.}
\todo{kulback-leibler add?}                                                                   
...
The similarity measure that is used in this thesis as explained in section 1.4 \todo{reference} does not fulfill the last point of the definition above and therefore, it does not form a metric space but a more general topological space. This is how \cite{stahl2014introduction} defines it. \\
...
%Cosine similarity represents the difference in the angle of two vectors.
...
However as experimental results presented in \todo{citation Kopp paper} in the domain of computer networks the overlap of clusters is not great.
