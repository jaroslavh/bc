...
The thesis is organized as follows. Chapter~\ref{ch:ids} anomaly-based network security.
In Chapter~\ref{ch:theory}, the theory behind clustering and representative selection in metric and non-metric spaces is explained.
Datasets used in for testing are presented in Chapter~\ref{ch:datasets}.
